...
If you wish to remove it manually, you can use a [Packed Hook](/hooks) or use a subdirectory.
:::

## Custom

If you wish to use a custom asset resolution strategy, you can implement the `AssetResolutionStrategy` interface along
with
