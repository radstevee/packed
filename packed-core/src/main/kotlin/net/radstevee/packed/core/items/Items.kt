...
/**
 * [Kudos to Minestom for having this on their github (again!)](https://github.com/Minestom/Minestom/blob/master/src/autogenerated/java/net/minestom/server/item/net.radstevee.packed.items.Materials.java)
 */
@Suppress("unused")
enum class Materials(val id: String) {
    AIR("minecraft:air"),
    ...
    val key: net.radstevee.packed.core.key.Key
        get() = net.radstevee.packed.core.key.Key.fromString(id)
}
