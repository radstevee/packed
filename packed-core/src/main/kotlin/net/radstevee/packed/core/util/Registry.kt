...
public open class Registry<T : Any>(
     ...
     */
    public fun register(key: String, entry: T): T {
     ...
     */
    public fun getKey(entry: T): String? {
     ...
     */
    public fun indexOf(entry: T): Int {
        return entries.indexOf(entry)
    }

    public fun collectEntries(): List<T> {
        return entries.toList()
    }

    public fun collectKeys(): List<String> {
        return keys.toList()
    }
     ...
     */
    public fun random(random: Random = Random, filter: ((T) -> Boolean)? = null): T? {
